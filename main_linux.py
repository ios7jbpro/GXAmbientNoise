...
# Function to show a warning about unavailable shortcuts
def warn_shortcuts_unavailable():
    yellow_bold = "\033[1;33m"  # ANSI escape code for bold yellow
    reset = "\033[0m"           # ANSI escape code to reset formatting
    print(f"{yellow_bold}WARNING: Keyboard shortcuts are not available on this platform.{reset}")
...
def main():
    ...
    if options:
        ...
        # Warn user about unavailable shortcuts
        warn_shortcuts_unavailable()
